const fs = require('fs');
const content = fs.readFileSync('./src/services/recipeService.ts', 'utf8');

// just extract the map and function
const GIMap = {
...
function inferIngredients(dishName) {
  ...
  return ['oil', 'onion', 'tomato', 'salt', 'turmeric', 'cumin', 'chili powder'];
}
...
const ing = inferIngredients('Sev Bhaji');
console.log('Ingredients:', ing);
console.log('GI Result:', computeGILevel(ing));
